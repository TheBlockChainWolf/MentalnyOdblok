...
import { Users, Zap, CheckCircle, ShieldCheck, Check, Lock, ArrowRight } from 'lucide-react';
    ...
    <div id="pricing" className="w-full bg-[#050505] pt-12 md:pt-20 pb-16 md:pb-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mb-12 md:mb-20 px-4 text-center relative z-10">
            <div className="flex flex-col items-center gap-2 group p-2">
                ...
                <div className="text-[10px] md:text-xs text-gray-500 uppercase tracking-wider font-semibold">Zmienionych podejść</div>
            </div>
            <div className="flex flex-col items-center gap-2 group p-2">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
            <div className="bg-[#0f0f0f] border border-gray-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6 md:p-12 border-b md:border-b-0 md:border-r border-gray-800 flex flex-col justify-center">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm mb-6 md:mb-8">Pełen system do pracy nad blokadami mentalnymi.</p>
                    ...
                    <ul className="space-y-3 md:space-y-4">
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <div>
                                <strong className="text-white block text-sm md:text-base">Zestaw Ćwiczeń "Reset"</strong>
            ...
            <div className="mt-8 md:mt-12 max-w-2xl mx-auto text-center bg-[#0a0a0a] border border-gray-800 p-5 md:p-6 rounded-2xl">
                <div className="flex flex-col md:flex-row items-center gap-4 text-left">
                    ...
                    <div className="text-center md:text-left">
                        <h4 className="text-white font-bold text-base md:text-lg">Gwarancja Satysfakcji</h4>
                        <p className="text-gray-400 text-xs md:text-sm leading-relaxed mt-1">
                            Jeśli uznasz, że ten workbook nie dostarczył Ci wartościowej wiedzy – napisz do mnie. <span className="text-white underline decoration-gray-600 underline-offset-2">Oddam Ci 100% pieniędzy.</span> Bez zbędnych pytań.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-6 text-center max-w-2xl mx-auto">
                <p className="text-[10px] text-gray-600 leading-tight">
                    Disclaimer: Produkt "Mentalny Odblok" ma charakter wyłącznie edukacyjny i rozwojowy. Nie zastępuje profesjonalnej porady medycznej, diagnozy ani terapii psychologicznej. W przypadku problemów ze zdrowiem psychicznym należy skonsultować się ze specjalistą.
                </p>
            </div>
            ...
            <div className="text-center mt-8 md:mt-12 mb-8">
                 <p className="text-gray-500 italic text-xs md:text-sm">
                    ...
                    Kawa daje energię na godzinę. <strong className="text-gray-300">Mentalny Odblok to narzędzia na lata.</strong>"
                 </p>
            </div>
        </div>
    </div>
